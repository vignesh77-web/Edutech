...
import InstructorLiveClasses from "./components/core/Dashboard/InstructorLiveClasses";
import InstructorTestSeries from "./components/core/Dashboard/InstructorTestSeries";
...

          {
            user?.accountType === ACCOUNT_TYPE.INSTRUCTOR && (
              <>
                ...
                <Route path="dashboard/manage-live-classes" element={<InstructorLiveClasses />} />
                <Route path="dashboard/manage-test-series" element={<InstructorTestSeries />} />
                <Route path="dashboard/add-test/:testSeriesId" element={<ManageTests />} />
